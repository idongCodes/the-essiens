        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs text-slate-400 mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-1">
              <span>{new Date(post.createdAt).toLocaleString(undefined, { month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit' })}</span>
              {post.isEdited && <span className="italic">(Edited)</span>}
              {post.location && (
                <span className="flex items-center text-brand-sky font-medium bg-sky-50 px-1.5 py-0.5 rounded">
